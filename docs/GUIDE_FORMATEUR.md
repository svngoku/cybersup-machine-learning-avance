...
- [R01 · An Introduction to Statistical Learning, with Applications in Python — James, Witten, Hastie, Tibshirani et Taylor, 2023](https://www.statlearning.com/)
- [R33 · Scikit-learn MOOC — Inria et contributeurs scikit-learn, ressource pédagogique vivante](https://inria.github.io/scikit-learn-mooc/)
...
- [R32 · Bank Marketing — Moro, Rita et Cortez ; UCI Machine Learning Repository, 2014, données 2008–2010](https://archive.ics.uci.edu/dataset/222/bank+marketing)
- R39 · Techniques de datamining : méthodologies et mise en pratique — Julie Hor, Sup de Vinci, 2020. Support local fourni : Méthodo Data Mining 2020.pdf
...
## Diapositive 9 · Exécuter un exemple dans Colab

Suivre docs/COLAB.md. Les variantes des TP02, TP03 et TP06 utilisent des données synthétiques. La démo08 télécharge le jeu UCI complet et vérifie son empreinte. Le dépôt reste privé : l'import du fichier local évite de demander un jeton GitHub aux étudiants. Colab nécessite un compte Google et une connexion ; les runtimes sont temporaires et l'accès au GPU n'est pas garanti. Le choix d'un GPU n'accélère pas automatiquement les estimateurs scikit-learn. Préparer la première installation avant la séance ; le parcours local reste disponible.

À retenir : CPU pour les TP ; GPU facultatif pour la démonstration XGBoost

- [R43 · Google Colab — Frequently Asked Questions — Google Colab, consulté le 19 septembre 2026](https://research.google.com/colaboratory/faq.html)
- [R46 · XGBoost GPU Support — branche 3.1 — Équipe XGBoost, documentation 3.1.3 consultée le 19 septembre 2026](https://xgboost.readthedocs.io/en/release_3.1.0/gpu/index.html)

## Diapositive 10 · Ce que nous reprenons des supports de 2020
...
- R38 · Introduction au Data Mining — Julie Hor, Sup de Vinci, 2020. Support local fourni : Cours 2020 Final - M1.pdf
- R39 · Techniques de datamining : méthodologies et mise en pratique — Julie Hor, Sup de Vinci, 2020. Support local fourni : Méthodo Data Mining 2020.pdf

## Diapositive 11 · Évaluer et régulariser
...
## Diapositive 12 · Le problème avant l'algorithme
...
## Diapositive 13 · Le contrat des données du fil rouge
...
## Diapositive 14 · Trois familles de fuites
...
- [R02 · Common pitfalls and recommended practices — Équipe scikit-learn, documentation 1.9.1, 2026](https://scikit-learn.org/stable/common_pitfalls.html)
- [R32 · Bank Marketing — Moro, Rita et Cortez ; UCI Machine Learning Repository, 2014, données 2008–2010](https://archive.ics.uci.edu/dataset/222/bank+marketing)

## Diapositive 15 · Entraînement, validation et test
...
- [R03 · Cross-validation: evaluating estimator performance — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/cross_validation.html)

## Diapositive 16 · Choisir le bon découpage
...
## Diapositive 17 · La pipeline apprend dans chaque pli
...
- [R02 · Common pitfalls and recommended practices — Équipe scikit-learn, documentation 1.9.1, 2026](https://scikit-learn.org/stable/common_pitfalls.html)
- [R18 · Preprocessing data — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/preprocessing.html)

## Diapositive 18 · La matrice de confusion se lit avec un coût
...
- [R04 · Metrics and scoring — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/model_evaluation.html)
- R39 · Techniques de datamining : méthodologies et mise en pratique — Julie Hor, Sup de Vinci, 2020. Support local fourni : Méthodo Data Mining 2020.pdf

## Diapositive 19 · Le piège de l'accuracy
...
## Diapositive 20 · ROC : ordonner les positifs et les négatifs
...
Validation synthétique (n=420) ; les points de la courbe correspondent à différents seuils.

- [R04 · Metrics and scoring — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/model_evaluation.html)

## Diapositive 21 · Précision-rappel : regarder les alertes utiles
...
Même validation que la ROC ; ligne de référence = prévalence observée. AP et aire trapézoïdale diffèrent.

- [R04 · Metrics and scoring — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/model_evaluation.html)

## Diapositive 22 · Évaluer une régression
...
## Diapositive 23 · Minimiser une perte avec une pénalité
...
- [R05 · Linear Models — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/linear_model.html)

## Diapositive 24 · Biais et variance
...
Courbes schématiques originales ; erreur = biais² + variance + bruit (0,5).

- [R08 · Single estimator versus bagging: bias-variance decomposition — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/auto_examples/ensemble/plot_bias_variance.html)

## Diapositive 25 · Courbes d'apprentissage
...
Valeurs construites pour expliquer un diagnostic ; aucun résultat de benchmark.

- [R08 · Single estimator versus bagging: bias-variance decomposition — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/auto_examples/ensemble/plot_bias_variance.html)

## Diapositive 26 · L1 et L2 n'ont pas le même effet
...
Exemple analytique à une variable, norme de x fixée et perte quadratique normalisée.

- [R05 · Linear Models — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/linear_model.html)

## Diapositive 27 · Elastic Net et choix de régularisation
...
## Diapositive 28 · SVM : marge et noyaux
...
- [R06 · Support Vector Machines — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/svm.html)

## Diapositive 29 · TP01 : établir la baseline
...
## Diapositive 30 · Quiz J1 : défendre son protocole
...
- [R02 · Common pitfalls and recommended practices — Équipe scikit-learn, documentation 1.9.1, 2026](https://scikit-learn.org/stable/common_pitfalls.html)
- [R03 · Cross-validation: evaluating estimator performance — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/cross_validation.html)
- [R16 · Probability calibration — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/calibration.html)

## Diapositive 31 · Les acquis du jour 1
...
## Diapositive 32 · Ensembles et optimisation
...
## Diapositive 33 · Un arbre partitionne l'espace
...
- [R40 · Decision Trees — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/tree.html)
- R39 · Techniques de datamining : méthodologies et mise en pratique — Julie Hor, Sup de Vinci, 2020. Support local fourni : Méthodo Data Mining 2020.pdf

## Diapositive 34 · Calculer un gain de Gini
...
## Diapositive 35 · Contrôler la complexité d'un arbre
...
## Diapositive 36 · Bagging : moyenner des modèles instables
...
- [R07 · Ensembles: gradient boosting, random forests, bagging, voting, stacking — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/ensemble.html)
- [R08 · Single estimator versus bagging: bias-variance decomposition — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/auto_examples/ensemble/plot_bias_variance.html)

## Diapositive 37 · Pourquoi la corrélation limite le gain
...
Formule théorique avec variance égale et corrélation commune ρ.

- [R08 · Single estimator versus bagging: bias-variance decomposition — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/auto_examples/ensemble/plot_bias_variance.html)

## Diapositive 38 · Random Forest : diversifier les divisions
...
## Diapositive 39 · Out-of-bag : utile avec ses limites
...
## Diapositive 40 · Boosting : corriger progressivement le modèle
...
- [R11 · Introduction to Boosted Trees — Équipe XGBoost, documentation 3.4.2, 2026](https://xgboost.readthedocs.io/en/stable/tutorials/model.html)

## Diapositive 41 · Une itération de boosting à la main
...
## Diapositive 42 · Le gradient généralise le résidu
...
## Diapositive 43 · Quand arrêter le boosting ?
...
Expérience synthétique Friedman, n=600, graine 42 ; code dans scripts/build_assets.py.

- [R07 · Ensembles: gradient boosting, random forests, bagging, voting, stacking — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/ensemble.html)
- [R09 · Tuning the hyper-parameters of an estimator — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/grid_search.html)

## Diapositive 44 · Boosting par histogrammes
...
- [R07 · Ensembles: gradient boosting, random forests, bagging, voting, stacking — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/ensemble.html)
- [R12 · Features of LightGBM — Équipe LightGBM, documentation 4.7.0, 2026](https://lightgbm.readthedocs.io/en/stable/Features.html)

## Diapositive 45 · Quatre implémentations à connaître
...
- [R11 · Introduction to Boosted Trees — Équipe XGBoost, documentation 3.4.2, 2026](https://xgboost.readthedocs.io/en/stable/tutorials/model.html)
- [R12 · Features of LightGBM — Équipe LightGBM, documentation 4.7.0, 2026](https://lightgbm.readthedocs.io/en/stable/Features.html)
- [R13 · How training is performed — Équipe CatBoost, consulté en 2026](https://catboost.ai/docs/en/concepts/algorithm-main-stages)

## Diapositive 46 · Voting et stacking
...
## Diapositive 50 · Grille, recherche aléatoire et TPE
...
- [R09 · Tuning the hyper-parameters of an estimator — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/grid_search.html)
- [R10 · Efficient Optimization Algorithms — Équipe Optuna, documentation vivante, consultée en 2026](https://optuna.readthedocs.io/en/stable/tutorial/10_key_features/003_efficient_optimization_algorithms.html)

## Diapositive 51 · Validation croisée imbriquée
...
## Diapositive 52 · L'optimisation a un coût mesurable
...
## Diapositive 53 · Interpréter une petite différence
...
## Diapositive 55 · Quiz J2 : mécanismes et protocole
...
## Diapositive 56 · Les acquis du jour 2
...
## Diapositive 57 · Déséquilibre et features
...
## Diapositive 58 · Trois décisions différentes
...
- [R16 · Probability calibration — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/calibration.html)
- [R17 · Tuning the decision threshold for class prediction — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/classification_threshold.html)

## Diapositive 59 · Donner un coût aux erreurs
...
## Diapositive 60 · Le seuil doit être choisi sur validation
...
Coûts pédagogiques sur validation synthétique. Le test ne sert pas à choisir le seuil.

- [R17 · Tuning the decision threshold for class prediction — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/classification_threshold.html)

## Diapositive 61 · Un seuil théorique sous hypothèses
...
## Diapositive 62 · Fβ et rappel sous contrainte
...
## Diapositive 63 · Cinq leviers contre le déséquilibre
...
- [R14 · Common pitfalls and recommended practices — Équipe imbalanced-learn, documentation 0.14.2, 2026](https://imbalanced-learn.org/stable/common_pitfalls.html)
- [R17 · Tuning the decision threshold for class prediction — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/classification_threshold.html)

## Diapositive 64 · Pondérer la fonction de perte
...
## Diapositive 65 · SMOTE : interpoler dans la classe minoritaire
...
- [R15 · SMOTE: Synthetic Minority Over-sampling Technique — Chawla, Bowyer, Hall et Kegelmeyer, 2002](https://www.jair.org/index.php/jair/article/view/10302)

## Diapositive 66 · Où placer le rééchantillonnage ?
...
## Diapositive 67 · Lire une courbe de calibration
...
Exemple schématique : une prédiction à 0,8 correspond ici à 0,64 observé.

- [R16 · Probability calibration — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/calibration.html)

## Diapositive 68 · Apprendre une calibration sans fuite
...
## Diapositive 69 · Concevoir des variables utiles
...
- [R18 · Preprocessing data — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/preprocessing.html)
- [R41 · Feature selection — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/feature_selection.html)

## Diapositive 70 · Valeurs manquantes et catégories inconnues
...
## Diapositive 71 · Target encoding et cross-fitting
...
- [R19 · TargetEncoder — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.TargetEncoder.html)

## Diapositive 72 · Ratios, interactions et variables temporelles
...
## Diapositive 73 · Sélection de variables et ablation
...
- [R41 · Feature selection — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/feature_selection.html)
- [R25 · Permutation feature importance — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/permutation_importance.html)

## Diapositive 74 · Corrélation : deux précisions utiles
...
## Diapositive 75 · TP04 : une décision validée
...
## Diapositive 76 · Atelier : auditer et enrichir les features
...
## Diapositive 77 · Quiz J3 : expliquer les compromis
...
## Diapositive 78 · Les acquis du jour 3
...
## Diapositive 79 · Clustering et anomalies
...
## Diapositive 80 · Un cluster dépend de la représentation
...
- [R20 · Clustering — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/clustering.html)

## Diapositive 81 · Distances et échelles
...
## Diapositive 82 · PCA : projeter en conservant de la variance
...
- [R22 · Decomposing signals in components — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/decomposition.html)

## Diapositive 83 · Lire la variance expliquée
...
Spectre construit pour l'exercice : les 3 premiers axes expliquent 88%, les 4 premiers 96%.

- [R22 · Decomposing signals in components — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/decomposition.html)

## Diapositive 84 · K-means : minimiser l'inertie
...
## Diapositive 85 · Une itération de K-means
...
## Diapositive 86 · Une géométrie que K-means représente mal
...
Mêmes 180 lunes synthétiques, graine 42. Les couleurs représentent les clusters estimés.

- [R20 · Clustering — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/clustering.html)

## Diapositive 87 · L'inertie ne choisit pas K à votre place
...
L'inertie optimale décroît avec K ; cette courbe ne prouve pas le vrai nombre de groupes.

- [R20 · Clustering — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/clustering.html)

## Diapositive 88 · Silhouette : séparation et compacité
...
## Diapositive 89 · GMM : une appartenance probabiliste
...
- [R21 · Gaussian mixture models — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/mixture.html)

## Diapositive 90 · EM : alterner deux problèmes plus simples
...
## Diapositive 91 · Classification hiérarchique agglomérative
...
## Diapositive 92 · DBSCAN : relier les régions denses
...
## Diapositive 93 · Les mêmes lunes avec DBSCAN
...
## Diapositive 94 · HDBSCAN : examiner plusieurs échelles
...
- [R23 · HDBSCAN — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/generated/sklearn.cluster.HDBSCAN.html)

## Diapositive 95 · Comparer les familles de clustering
...
## Diapositive 96 · Évaluer sans labels
...
## Diapositive 97 · Projections : explorer avec prudence
...
- [R22 · Decomposing signals in components — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/decomposition.html)
- [R42 · Manifold learning — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/manifold.html)

## Diapositive 98 · Anomalie, nouveauté et classe rare
...
- [R24 · Novelty and Outlier Detection — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/outlier_detection.html)

## Diapositive 99 · TP05 : expliquer une partition
...
## Diapositive 100 · Quiz J4 : reconnaître les hypothèses
...
## Diapositive 101 · Les acquis du jour 4
...
## Diapositive 102 · Interpréter et restituer
...
## Diapositive 103 · Trois niveaux d'explication
...
- [R25 · Permutation feature importance — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/permutation_importance.html)
- [R27 · A Unified Approach to Interpreting Model Predictions — Lundberg et Lee, NeurIPS 2017](https://papers.nips.cc/paper/2017/hash/8a20a8621978632d76c43dfd28b67767-Abstract.html)

## Diapositive 104 · Importance par permutation
...
Friedman synthétique : x0 à x4 sont informatives par construction. Importance sur validation, 5 permutations.

- [R25 · Permutation feature importance — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/permutation_importance.html)

## Diapositive 105 · Variables corrélées : une explication ambiguë
...
- [R26 · Partial Dependence and Individual Conditional Expectation — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/partial_dependence.html)

## Diapositive 107 · SHAP : répartir une différence de prédiction
...
- [R27 · A Unified Approach to Interpreting Model Predictions — Lundberg et Lee, NeurIPS 2017](https://papers.nips.cc/paper/2017/hash/8a20a8621978632d76c43dfd28b67767-Abstract.html)
- [R28 · SHAP documentation — Équipe SHAP, consulté en 2026](https://shap.readthedocs.io/en/latest/)

## Diapositive 108 · Un calcul de Shapley à deux variables
...
## Diapositive 109 · Une prédiction ponctuelle laisse une incertitude
...
- [R29 · A Gentle Introduction to Conformal Prediction and Distribution-Free Uncertainty Quantification — Angelopoulos et Bates, 2021, révisions ultérieures](https://arxiv.org/abs/2107.07511)

## Diapositive 110 · Split-conformal : trois ensembles séparés
...
## Diapositive 111 · Lire les intervalles conformes
...
Split-conformal 90% : 600 train, 200 calibration, 200 test ; extrait des 40 plus petites prédictions. Couverture marginale, pas individuelle.

- [R29 · A Gentle Introduction to Conformal Prediction and Distribution-Free Uncertainty Quantification — Angelopoulos et Bates, 2021, révisions ultérieures](https://arxiv.org/abs/2107.07511)

## Diapositive 112 · Évaluer des segments
...
- [R30 · Model Cards for Model Reporting — Mitchell et al., 2019 (prépublication 2018)](https://arxiv.org/abs/1810.03993)
- [R16 · Probability calibration — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/modules/calibration.html)

## Diapositive 113 · Préparer un modèle à être utilisé
...
- [R31 · Model persistence — Équipe scikit-learn, 2026](https://scikit-learn.org/stable/model_persistence.html)
- [R30 · Model Cards for Model Reporting — Mitchell et al., 2019 (prépublication 2018)](https://arxiv.org/abs/1810.03993)

## Diapositive 114 · Trois dérives à distinguer
...
## Diapositive 115 · Une distribution différente n'est qu'un signal
...
Distributions construites : un changement de P(X) ne prouve pas une baisse de performance.

- [R30 · Model Cards for Model Reporting — Mitchell et al., 2019 (prépublication 2018)](https://arxiv.org/abs/1810.03993)

## Diapositive 116 · La model card rend les limites visibles
...
## Diapositive 117 · TP06 : expliquer et quantifier

Une variante Colab autonome est disponible dans notebooks/colab/etudiants/06_interpretation.ipynb ; elle utilise le CPU. Quatre sous-ensembles sont explicités : train, diagnostic, calibration conforme et test. Le jeu diagnostic ne doit pas devenir un substitut du test final. La calibration conforme est distincte de la calibration probabiliste du jour 3. Demander aux étudiants de dire à voix haute de laquelle ils parlent.
...
## Diapositive 118 · Veille au 19 septembre 2026
...
- [R34 · Version 1.9 release notes — Équipe scikit-learn, juin 2026 ; correctif 1.9.1 septembre 2026](https://scikit-learn.org/stable/whats_new/v1.9.html)
- [R36 · TabArena: A Living Benchmark for Machine Learning on Tabular Data — Erickson et al., 2025](https://arxiv.org/abs/2506.16791)
- [R44 · Ray Overview — Équipe Ray, documentation 2.58.0 consultée le 19 septembre 2026](https://docs.ray.io/en/latest/ray-overview/index.html)
- [R45 · Ray Tune — Équipe Ray, consulté le 19 septembre 2026](https://docs.ray.io/en/latest/tune/index.html)
- [R47 · Ray: A Distributed Framework for Emerging AI Applications — Moritz et al., OSDI 2018](https://www.usenix.org/conference/osdi18/presentation/moritz)
- [R48 · Ray Train — Équipe Ray, consulté le 19 septembre 2026](https://docs.ray.io/en/latest/train/train.html)
- [R49 · Ray Data — Équipe Ray, consulté le 19 septembre 2026](https://docs.ray.io/en/latest/data/data.html)

## Diapositive 119 · TabPFN : publication et annonce récente
...
- [R35 · Accurate predictions on small data with a tabular foundation model — Hollmann et al., Nature, 8 janvier 2025](https://www.nature.com/articles/s41586-024-08328-6)
- [R37 · TabPFN-3.5: Technical Report — Prior Labs, 15 septembre 2026](https://priorlabs.ai/technical-reports/tabpfn-3-5)

## Diapositive 120 · Lire un benchmark de façon critique
...
## Diapositive 121 · Projet final : prioriser une campagne
...
## Diapositive 122 · Une évaluation sur des preuves
...
## Diapositive 123 · Soutenance : cinq minutes pour décider
...
## Diapositive 124 · Quiz final : raisonner sur un cas nouveau
...
## Diapositive 125 · Ressources : apprendre et pratiquer
...
## Diapositive 126 · Ressources : articles et veille
...
## Diapositive 127 · Ce que vous savez maintenant défendre
